...
import { TableCommande , TableCategogie , TableComment , TableUser ,TableCodePromo ,TableProduit } from '../../_metronic/partials/widgets'
  ...
  return (
    <Routes>
      <Route element={<MasterLayout />}>
        ...
        <Route path='produits' element={ <TableProduit className='mb-5 mb-xl-8' />} />
        ...
        <Route path='categories' element={ <TableCategogie className='mb-5 mb-xl-8' />} />
