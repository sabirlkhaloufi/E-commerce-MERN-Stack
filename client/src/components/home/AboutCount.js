                            ...
                            { FeatureItems.map( ( data , i ) => (
                                ...
                                >
                                    <div className="edu-counterup">
                                        <div className="inner">
                                            <div className="icon">
                                                <img src={`${process.env.PUBLIC_URL}./images/about/${ data.image }`} alt="Icon Thumb" />
                                            </div>
                            ...
                            <div className="inner">
                                ...
                                >
                                    <div className="edu-feature-list">
                                        <div className="icon">
                                        <img src={`${process.env.PUBLIC_URL}./images/about/smile.png`} alt="Icon Thumb" />
                                        </div>
                                        <div className="content">
